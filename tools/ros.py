...
import sys
sys.path.append("/home/xxx/pointpillars_ws/src/pointpillars_ros")
...
class Pointpillars_ROS:
    ...
    def init_ros(self):
        ...
        config_path = rospy.get_param("/config_path", "/home/xxx/pointpillars_ws/src/pointpillars_ros/tools/cfgs/kitti_models/pointpillar.yaml")
        ckpt_path = rospy.get_param("/ckpt_path", "/home/xxx/pointpillars_ws/src/pointpillars_ros/tools/pointpillar_7728.pth")
        # # subscriber
